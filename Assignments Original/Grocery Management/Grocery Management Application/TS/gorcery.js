...
function showBillFunction() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        orderList.forEach(order => {
            ...
            `;
                let singleOrderTable = document.getElementById("orderItem" + order.orderID);
                // singleOrderTable.innerHTML= "";
                let singleOrderID = document.getElementById("orderID" + order.orderID);
                ...
                let singleBillAmount = document.getElementById("billAmount" + order.orderID);
                singleBillAmount.innerHTML = `Bill Amount : ${order.billAmount}<br><br>`;
            }
        });
    });
}
function downloadOrderHistory(tableID, orderID, billAmount) {
    let csv_data = [];
...
function downloadCSVFile(csvData, orderID) {
